...
export class PlayerAction extends ethereum.Event {
  get params(): PlayerAction__Params {
    return new PlayerAction__Params(this);
  }
}

export class PlayerAction__Params {
  _event: PlayerAction;

  constructor(event: PlayerAction) {
    this._event = event;
  }
...
export class CreateOrUpdateOrDeletePlayerCall extends ethereum.Call {
  get inputs(): CreateOrUpdateOrDeletePlayerCall__Inputs {
    return new CreateOrUpdateOrDeletePlayerCall__Inputs(this);
  }

  get outputs(): CreateOrUpdateOrDeletePlayerCall__Outputs {
    return new CreateOrUpdateOrDeletePlayerCall__Outputs(this);
  }
}

export class CreateOrUpdateOrDeletePlayerCall__Inputs {
  _call: CreateOrUpdateOrDeletePlayerCall;

  constructor(call: CreateOrUpdateOrDeletePlayerCall) {
    this._call = call;
  }
...
export class CreateOrUpdateOrDeletePlayerCall__Outputs {
  _call: CreateOrUpdateOrDeletePlayerCall;
